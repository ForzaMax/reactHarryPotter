...
export const Card = ({
  ...
  const { favorites, setFavorites, addFavorites, removeFavorites, isFavorite } =
  ...
  return (
    <div className={s.card}>
      <img className={s.card__image} src={image ? image : defaultImg} alt="" />
      ...
      <div className={s.card__info}>
        ...
        <p className={s.card__desc}>{alive ? "Alive: alive" : "Alive: dead"}</p>
      </div>
    </div>
  );
};
